...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[{
                'image_directory': '/home/jorgelop/Documents/VantTec_SDV_SWARM/SDV_Proyect/SDV_Software_Workspaces/vo_ws/src/vodom_first/include/Kitti_Sequence_Larga/image_0'
            }]
        ),
        ...
        Node(
            ...
            output='screen',
            parameters=[{
                'pose_file_path': '/home/jorgelop/Documents/VantTec_SDV_SWARM/SDV_Proyect/SDV_Software_Workspaces/vo_ws/src/vodom_first/include/Kitti_Sequence_Larga/poses.txt'
            }]
        ),
